 ...
 *  - UP+DN короткий аккорд: переключить активный канал
 *    (State_SetEnabled(ch,!State_IsEnabled(ch))); при включении дополнительно
 *    сбрасывает Sleep канала в AWAKE (Sleep_ForceAwake), см. sleep.h.
