 ...
 *  - CHANNEL_SOLDER:   Dock_Pin (датчик подставки, PA1 на новой ревизии
 *                       платы — было PB0+EXTI0, см. чат). Простой = паяльник
 *                       запаркован (Dock==1, активный уровень ВЫСОКИЙ —
 *                       проверено на железе, не совпадает с Btn_Pump ниже;
 *                       обычный вход, GPIO_PULLUP, без EXTI — опрашивается
 *                       поллингом здесь же, см. gpio.c).
